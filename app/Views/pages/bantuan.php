...
<main class="container-fluid">
    ...
    <div class="m-4 accordion" id="accordionExample">
        <h4 class="my-4 txt-bold">Frequently Asked Question</h4>
        <div class="accordion-item">
            <!-- Question 1 -->
            <h2 class="accordion-header" id="ask1">
                <button class="accordion-button collapsed txt-md" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="collapse1">
                    Q: Lorem Ipsum
                </button>
            </h2>
